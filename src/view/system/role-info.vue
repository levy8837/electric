            ...
            <div>
                <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="100">
                    <Row :gutter="24" class='row-wrap'>
                        ...
                        <FormItem label="角色器编号" prop="routerInformationId">
    ...
    export default {
        ...
        data() {
            return {
                ...
                ruleValidate: {
                    routerInformationId: [
                        { required: true, type:'number', message: '请输入角色器编号', trigger: 'blur' }
                    ],
        ...
        methods: {
            ...
            deleteHandler(data) {
             ...
             addHandler() {
                ...
                this.modelTitle = '新增角色器配置';
            },
            //编辑
            editHandler(index) {
                this.isEdit = true;
                this.isAddRouterConfig = true;
                this.modelTitle = '编辑角色器配置信息';
