                ...
                <Form ref="formValidate" :model="formValidate" :label-width="100">
                    <Row :gutter="24" class='row-wrap'>
                        ...
                        <FormItem label="设备编号" prop="equipmentNumber">
                            <Input disabled v-model="formValidate.equipmentNumber" placeholder="请输入设备编号"></Input>
                        </FormItem>
                        </Col>
                    </Row>
                    <Row :gutter="24" class='row-wrap'>
    ...
    export default {
        ...
        methods: {
            ...
            editHandler(index) {
                ...
                if(this.formValidate.onLineStatus=='在线'){
                    this.formValidate.onLineStatus=1;
                }else{
                    this.formValidate.onLineStatus=0;
                }
            },
            handleCancle() {
